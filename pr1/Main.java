...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("\nAfter the deletion of the item:");
        System.out.println(cart);
        */

        //honestly this is probably the worst code i've written in the past month i hate doing open-ended homework

        History orderHistory = new History();

        List<Product> productList = new ArrayList<>(); //for the search function
